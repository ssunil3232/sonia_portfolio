    ...
    return (
        <div style={{ background: 'white' }}>
            <div className="flex w-screen flex-col items-center overflow-x-hidden relative" style={{ backgroundImage: `url(${cover})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}>
                <div className='nanum-myeongjo-regular w-[65%]' style={{ textAlign: 'center', fontSize: '25px', marginBottom: 50, marginTop: 600, marginRight: 400 }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    ...
                    <div className='flex flex-row justify-center w-[90%]' style={{ marginTop: '20px' }}>
                        <img src={participants} alt="participants" style={{ height: '250px', borderRadius: 10, marginRight: 20 }} />
                        <img src={recruitment} alt="recruitment" style={{ height: '250px', borderRadius: 10 }} />
                    </div>
                    <div className='flex flex-row justify-center w-[90%]' style={{ marginTop: '20px' }}>
                    ...
                    <div className='flex justify-center w-[90%]' style={{ marginTop: '40px' }}>
                        <img src={interview} alt="interview" style={{ height: '300px' }} />
                    </div>
                </div>
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    ...
                    <div className='flex justify-center w-[90%]'>
                        <img src={insights} alt="insights" style={{ height: '500px', marginTop: 20 }} />
                    </div>
                </div>
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    ...
                    <div className='flex justify-center w-[90%]'>
                        <img src={requirements} alt="requirements" style={{ height: '200px', marginBottom: 50, marginTop: 20 }} />
                    </div>
                </div>
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px' }}>
                    <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                    ...
                    <div className='flex justify-center w-[90%]' style={{ marginTop: '10px', marginBottom: '50px' }}>
                        <div style={{ position: 'relative', marginTop: '20px' }}>
                            <a href="https://miro.com/app/board/uXjVNbfPgj4=/?share_link_id=590673931007" target="_blank" rel="noopener noreferrer">
                                <img src={idea} alt="idea" style={{ height: '500px' }} />
                            </a>
                            <img src={cursor} alt="cursor" style={{ height: '200px', position: 'absolute', right: '-150px', bottom: '-50px' }} />
                        </div>
                    </div>
                ...
                <div className='w-[100%] justify-center items-center flex flex-col'>
                    ...
                    <div className='flex flex-col justify-center items-center w-[90%]' style={{ marginBottom: '50px' }}>
                        <img src={pillar} alt="pillar" style={{ height: '400px' }} />
                    </div>
                </div>
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px' }}>
                    <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px' }}>
                    ...
                    <div className='flex flex-col justify-center items-center w-[90%]' style={{ marginBottom: '50px' }}>
                        <img src={hifi} alt="hifi" style={{ height: '500px', marginBottom: 10, width: '900px' }} />
                    </div>
                </div>
                <div className='w-[100%] justify-center items-center flex flex-col' style={{ backgroundImage: `url(${backgroundReverse})`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'bottom' }}>
                    ...
                    <div className='flex flex-col justify-center items-center w-[90%]' style={{ marginBottom: '50px' }}>
                        <img src={presentation} alt="presentation" style={{ height: '400px', marginBottom: 10, borderRadius: 15 }} />
                    </div>
                    <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px' }}>
                        <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                            Figma Link
                        ...
                        <div className='flex flex-col justify-center items-center w-[90%]' style={{ marginBottom: '50px' }}>
                            <a className='mx-5' href="https://www.figma.com/design/XguQMbQ4PK1XiE5dcndTkU/HCI-Figma?node-id=836-9283&t=D22wRVIrBqStiWuz-1" target="_blank" title="Hi-Fi Prototype">
                                <img src={figma} alt="figma" style={{ height: '500px', marginBottom: 10, width: '700px' }} />
                            </a>
                        </div>
                    </div>
                </div>
