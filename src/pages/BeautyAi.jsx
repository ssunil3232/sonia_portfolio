        ...
        <div style={{ background: 'white' }}>
            <div className="flex w-screen flex-col items-center overflow-x-hidden relative" style={{ backgroundImage: `url(${cover})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat' }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    ...
                    <div className='flex lg:flex-row md:flex-col flex-wrap justify-center items-center lg:w-[90%] sm:w-[80%] md:w-[80%]' style={{ marginTop: '20px' }}>
                    ...
                    <div className='flex flex-row justify-center lg:w-[90%] sm:w-[80%] md:w-[80%]' style={{ marginTop: '20px' }}>
                    ...
                    <div className='flex justify-center lg:w-[90%] sm:w-[80%] md:w-[80%]' style={{ marginTop: '40px' }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
                    ...
                    <div className='flex justify-center lg:w-[90%] sm:w-[80%] md:w-[80%]'>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px' }}>
                    ...
                    <div className='flex justify-center lg:w-[90%] sm:w-[80%] md:w-[80%]' style={{ marginTop: '10px', marginBottom: '50px' }}>
                ...
                <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px' }}>
                    ...
                    <div className='flex flex-col justify-center items-center lg:w-[90%] sm:w-[80%] md:w-[80%]' style={{ marginBottom: '50px' }}>
