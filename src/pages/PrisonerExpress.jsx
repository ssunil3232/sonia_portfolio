...
import implement from '../img/prisonerExpress/implement.png';
import pwa from '../img/prisonerExpress/pwa.png';
         ...
         <div className="flex w-screen flex-col items-center overflow-x-hidden relative" style={{ backgroundImage: `url(${backgroundSvg})`, backgroundSize: 'auto', backgroundRepeat: 'no-repeat' }}>
            <div className='flex flex-row justify-evenly items-center' style={{ marginTop: '150px', marginLeft: '50px' }}>
               <div className="title" style={{ fontSize: '8rem' }}>
                  <div className='poiret-one-regular'>PRISONER</div>
                  <div className='poiret-one-regular'>EXPRESS</div>
               </div>
               <img src={logo} alt="logo" style={{ height: '200px', width: '650px' }} />
            </div>
            <div>
               <img src={preview} alt="preview" style={{ height: '500px', width: '950px', marginTop: 50, marginBottom: 50, borderRadius: 10 }} />
            </div>
            ...
            <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
               ...
               <div className='flex items-center w-[90%] justify-center'>
                  <img src={prisoner} alt="prisoner" style={{ height: '400px', width: '900px', marginTop: '20px', }} />
               </div>
               <div className='flex items-center w-[90%] justify-center'>
                  <div className='flex flex-col items-start'>
                     ...
                     <img src={task1} alt="task1" style={{ height: '400px', width: '900px', marginTop: '20px', }} />
                  </div>
               </div>
               <div className='inter-semibold flex items-start' style={{ fontSize: '20px', marginTop: '20px', color: '#8C8383' }}>
               ...
               <div className='flex items-center w-[90%] justify-center'>
                  <img src={admin} alt="admin" style={{ height: '400px', width: '900px', marginTop: '20px', }} />
               </div>
               <div className='flex items-center w-[90%] justify-center'>
                  <div className='flex flex-col items-start'>
                     <div className='inter-light flex justify-start items-start' style={{ fontSize: '20px', marginTop: '20px', color: '#8C8383' }}>
                     ...
                     <img src={task2} alt="task2" style={{ height: '500px', width: '900px', marginTop: '20px', }} />
                  </div>
               </div>
            </div>
            <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
               ...
               <div style={{ position: 'relative' }}>
                  <a href="https://www.figma.com/board/ZhovCH4zplCXi5do2lVPFF/Idea-Board-for-Prisoner-Express-App?node-id=0-1&t=qqnfSlB1AGa8EbD4-1" target="_blank" rel="noopener noreferrer">
                     <img src={idea} alt="idea" style={{ height: '500px', width: '90%', marginTop: '20px', marginBottom: '20px' }} />
                  </a>
                  <img src={cursor} alt="cursor" style={{ height: '200px', position: 'absolute', right: '0px', bottom: '-100px' }} />
               </div>
               <div className='nanum-myeongjo-regular w-[80%]'>
               ...
               <div style={{ position: 'relative' }}>
                  <a href="https://www.figma.com/board/MhCNAdnU4ZEkhDyAnHmMkM/Design-Flows?node-id=0-1&t=aX20NYmzJCllQQfR-1" target="_blank" rel="noopener noreferrer">
                     <img src={final} alt="final" style={{ height: '700px', width: '90%', marginTop: '20px', marginBottom: '20px' }} />
                  </a>
            ...
            <div style={{ marginTop: '20px', marginBottom: '20px' }}>
               <img src={implement} alt="implement" style={{ height: '400px' }} />
            </div>
            <div style={{ marginTop: '20px', marginBottom: '20px' }}>
               <img src={pwa} alt="pwa" style={{ height: '780px' }} />
            </div>
            <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px' }}>
               <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                  Usability Testing
            ...
            <div style={{ marginTop: '20px', marginBottom: '20px' }}>
               <img src={testing} alt="testing" style={{ height: '500px' }} />
            </div> 
            ...
            <div>
               <img src={presentation} alt="presentation" style={{ height: '400px', marginBottom: 50 }} />
            </div>
            <div className='flex flex-col justify-start w-screen' style={{ marginLeft: '150px', marginTop: '20px'}}>
               <div className='nanum-myeongjo-extrabold' style={{ fontSize: '25px' }}>
                  Artifacts:
