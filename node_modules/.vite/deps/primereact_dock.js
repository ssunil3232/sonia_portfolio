...
var Dock = React5.memo(React5.forwardRef(function(inProps, ref) {
  var _React$useState = React5.useState(-3), _React$useState2 = _slicedToArray4(_React$useState, 2), currentIndexState = _React$useState2[0], setCurrentIndexState = _React$useState2[1];
  var _React$useState3 = React5.useState(false), _React$useState4 = _slicedToArray4(_React$useState3, 2), focused = _React$useState4[0], setFocused = _React$useState4[1];
  var _React$useState5 = React5.useState(-1), _React$useState6 = _slicedToArray4(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var mergeProps2 = useMergeProps();
  var context = React5.useContext(PrimeReactContext);
  var props = DockBase.getProps(inProps, context);
  var _React$useState7 = React5.useState(props.id), _React$useState8 = _slicedToArray4(_React$useState7, 2), idState = _React$useState8[0], setIdState = _React$useState8[1];
  ...
  var listRef = React5.useRef(null);
  ...
  var findNextOptionIndex = function findNextOptionIndex2(index) {
    ...
    var matchedOptionIndex = _toConsumableArray3(menuitems).findIndex(function(link) {
  ...
  var createItem = function createItem2(item, index) {
    ...
    var icon = IconUtils.getJSXIcon(_icon, _objectSpread4({}, iconProps), {
      props
    });
    ...
    var content = React5.createElement("a", actionProps, icon, React5.createElement(Ripple, null));
    if (template) {
    ...
    var menuitemProps = mergeProps2(_defineProperty5(_defineProperty5({
      id: key,
      role: "menuitem",
      key,
      "aria-label": label,
    ...
    return React5.createElement("li", menuitemProps, React5.createElement("div", contentProps, content));
  };
  ...
  var createHeader = function createHeader2() {
    if (props.header) {
      ...
      return React5.createElement("div", headerProps, _header);
    }
    return null;
  };
  var createList = function createList2() {
    ...
    return React5.createElement("ul", menuProps, items);
  };
  var createFooter = function createFooter2() {
    if (props.footer) {
      ...
      return React5.createElement("div", footerProps, _footer);
    }
    return null;
  };
  useMountEffect(function() {
  ...
  return React5.createElement("div", _extends3({
    id: props.id,
    ref: elementRef
  }, rootProps), React5.createElement("div", containerProps, header, list, footer));
}));
